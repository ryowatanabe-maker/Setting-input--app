...
# --- 0. 店舗名入力 ---
st.title("FitPlus ⚙️ 統合設定ツール (安定インポート版)")
...
# --- 4. 出力 (成功した19の73列構成を厳守・パレットスペース・分割出力) ---
st.divider()
if st.button("📦 ゲートウェイ用 .tar を生成", type="primary", use_container_width=True):
    ...
    # Timetable (73列を維持するため、6件ごとに強制改行)
    idx_tt = 0
    for z_name in vz:
